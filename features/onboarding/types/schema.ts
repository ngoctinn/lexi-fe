...
export const onboardingSchema = z.object({
  ...
  current_level: z.enum(ONBOARDING_LEVEL_OPTIONS, {
    errorMap: () => ({ message: "Vui lòng chọn trình độ hiện tại của bạn" }),
  }),
  target_level: z.enum(ONBOARDING_LEVEL_OPTIONS, {
    errorMap: () => ({ message: "Vui lòng chọn trình độ mục tiêu của bạn" }),
  }),
