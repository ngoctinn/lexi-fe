    ...
    <div className="flex w-full flex-col gap-8 animate-in fade-in zoom-in-95 duration-500">
      <div className="flex flex-col items-center justify-center text-center pb-6">
          ...
          <div className="flex size-40 flex-col items-center justify-center rounded-full bg-background border shadow-xl">
            ...
            <span
              className={cn(
                ...
                getScoreColorClass(scoring.overall),
              )}
            >
        ...
        <h2 className="text-xl md:text-3xl font-bold max-w-lg leading-tight">
          Hoàn thành tốt! AI đánh giá bạn đạt {Math.round(scoring.overall)}/100
          điểm.
        </h2>
        {scoring.feedback && (
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {skills.map((skill) => (
          <Card
            key={skill.key}
            className="flex flex-col border-border/60 hover:border-border transition-colors shadow-sm"
          >
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={cn(
                    ...
                    getScoreColorClass(skill.score),
                  )}
                >
            ...
            <CardContent className="p-4 pt-2">
              <Progress
                ...
                className={cn(
                  "h-2 w-full bg-muted",
                  `[&>[data-slot=progress-indicator]]:${getProgressColorClass(skill.score)}`,
                )}
              />
            </CardContent>
          </Card>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card className="flex flex-col items-center p-4 bg-warning/5 border-warning/20">
          <span className="text-3xl font-bold text-warning-dark">
