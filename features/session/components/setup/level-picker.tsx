...
const LEVELS = [
  {
    value: "A1",
    label: "A1 — Beginner",
    description: "Mới bắt đầu, biết từ vựng căn bản",
  },
  {
    value: "A2",
    label: "A2 — Elementary",
    description: "Giao tiếp được trong các tình huống đơn giản",
  },
  {
    value: "B1",
    label: "B1 — Intermediate",
    description: "Đủ dùng để đi du lịch hoặc làm việc đơn giản",
  },
  {
    value: "B2",
    label: "B2 — Upper-Intermediate",
    description: "Giao tiếp khá trôi chảy về các chủ đề phổ thông",
  },
  {
    value: "C1",
    label: "C1 — Advanced",
    description: "Khả năng ngôn ngữ linh hoạt, học thuật cao",
  },
  {
    value: "C2",
    label: "C2 — Proficient",
    description: "Sử dụng tiếng Anh tự nhiên như người bản xứ",
  },
] as const;
